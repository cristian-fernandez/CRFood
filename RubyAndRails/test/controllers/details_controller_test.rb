...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { description: @detail.description, directions: @detail.directions, history: @detail.history, idFood: @detail.idFood, ingredients: @detail.ingredients }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { description: @detail.description, directions: @detail.directions, history: @detail.history, idFood: @detail.idFood, ingredients: @detail.ingredients }
    assert_redirected_to detail_path(assigns(:detail))
  end
